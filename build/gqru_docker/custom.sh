...
sed -i "s/OpenWrt /ONE build $(TZ=UTC-8 date "+%Y.%m.%d") @ GanQuanRu_docker /g" $ZZZ              # 增加自己个性名称
...
# ●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●● #
sed -i 's#%D %V, %C#%D %V, %C GanQuanRu_docker#g' package/base-files/files/etc/banner               # 自定义banner显示
